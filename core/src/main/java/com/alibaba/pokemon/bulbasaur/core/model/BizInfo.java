...
import static com.alibaba.pokemon.bulbasaur.core.constants.XmlTagConstants.INFO_TAG;
import static com.alibaba.pokemon.bulbasaur.core.constants.XmlTagConstants.KEY_TAG;
...
public class BizInfo extends NotRunnableState {
    ...
    /* (non-Javadoc)
     * @see com.alibaba.pokemon.bulbasaur.core.model.StateLike#getJumpTo()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.alibaba.pokemon.bulbasaur.core.model.StateLike#setBizId(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.alibaba.pokemon.bulbasaur.core.model.StateLike#setJumpTo(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.alibaba.pokemon.bulbasaur.core.model.StateLike#setDefinitionName(java.lang.String)
     */
    @Override
